...
EOF
	...
	mcopy -i ${WORKDIR}/${BOOT_IMG} -s ${TMPDIR}/../../../../linux/linux/arch/arm/boot/zImage ::
	mcopy -i ${WORKDIR}/${BOOT_IMG} -s ${TMPDIR}/../../../../linux/linux/arch/arm/boot/dts/rockchip/rk3288-tinker.dtb ::
	mmd -i ${WORKDIR}/${BOOT_IMG} ::/extlinux
	mcopy -i ${WORKDIR}/${BOOT_IMG} -s ${TMPDIR}/../../../patches/rk3288.conf ::/extlinux/extlinux.conf
	mcopy -i ${WORKDIR}/${BOOT_IMG} -s ${TMPDIR}/../../../../linux/hw_intf.conf ::
