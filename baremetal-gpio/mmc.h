...
/* CRU_CLKSEL11_CON */
#define MMC0_PLL_SHIFT           6
#define MMC0_PLL_MASK            3 << MMC0_PLL_SHIFT
#define MMC0_PLL_SELECT_CODEC    0
#define MMC0_PLL_SELECT_GENERAL  1
#define MMC0_PLL_SELECT_24MHZ    2
#define MMC0_DIV_SHIFT           0
#define MMC0_DIV_MASK            0x3f << MMC0_DIV_SHIFT
